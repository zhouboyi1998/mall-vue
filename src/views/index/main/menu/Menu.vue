        ...
        <el-card class="main-container" shadow="hover">
            ...
            <el-table :data="tableData" stripe style="width: 100%">
                <el-table-column
                    ...
                    :width="item.width"
                >
                    <template v-slot="{ row }" v-if="item.prop === 'menuStatus'">
                        <el-switch
                            class="ml-2"
                            v-model="row.menuStatus"
                            :active-value="1"
                            :inactive-value="0"
...
import { selectMenuPage, updateMenu } from '@/api/admin/menu'
...
const changeStatus = async (row) => {
    let menu = { id: row.id, menuStatus: row.menuStatus }
